      ...
      <section className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="glass rounded-[2rem] p-6 shadow-2xl shadow-violet-950/30">
          ...
          <div className="space-y-4">
            ...
            <input name="birth_place" placeholder="Birth place, for example Paris, France" value={form.birth_place} onChange={handleChange} className="w-full rounded-2xl border border-white/10 bg-slate-950/70 px-4 py-3 outline-none" />
